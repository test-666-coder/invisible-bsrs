...
#place(left + horizon, dx: 0.72in, dy: -0.15in)[
  #text(size: 36pt, weight: "bold", fill: white)[AI 不能決定誰有危險]
  #v(0.12in) #text(size: 36pt, weight: "bold", fill: white)[但能讓每一句不容易說出口的求救]
  #v(0.12in) #text(size: 36pt, weight: "bold", fill: white)[都有機會被專業人員看見。]
]
#place(bottom + left, dx: 0.72in, dy: -0.6in)[#text(size: 14pt, fill: rgb("#E9CAC5"))[用傾聽取代填表｜專業人員完成判斷]]
